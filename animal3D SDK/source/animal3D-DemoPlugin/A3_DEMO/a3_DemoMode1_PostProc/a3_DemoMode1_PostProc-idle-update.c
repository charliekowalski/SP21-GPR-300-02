...
void a3postproc_update_graphics(a3_DemoState* demoState, a3_DemoMode1_PostProc* demoMode)
{
	...
	a3bufferRefillOffset(demoState->ubo_transform, 0, sizeof(demoMode->projectorMatrixStack), sizeof(demoMode->modelMatrixStack), demoMode->modelMatrixStack);	//Model data
	a3bufferRefillOffset(demoState->ubo_light, 0, 0, sizeof(demoMode->pointLightData), demoMode->pointLightData);	//Lights data
}
