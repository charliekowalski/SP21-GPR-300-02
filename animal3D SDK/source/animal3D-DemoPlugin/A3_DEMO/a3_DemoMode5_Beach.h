...
#ifndef __ANIMAL3D_DEMOMODE5_BEACH_H
#define __ANIMAL3D_DEMOMODE5_BEACH_H
...
{
#else	// !__cplusplus
typedef struct a3_DemoMode5_Beach						a3_DemoMode5_Beach;
typedef enum a3_DemoMode5_Beach_RenderMode				a3_DemoMode5_Beach_RenderMode;
typedef enum a3_DemoMode5_Beach_RenderPipeline			a3_DemoMode5_Beach_RenderPipeline;
typedef enum a3_DemoMode5_Beach_RenderPass				a3_DemoMode5_Beach_RenderPass;
typedef enum a3_DemoMode5_Beach_RenderTarget			a3_DemoMode5_Beach_RenderTarget;
#endif	// __cplusplus
...
// render modes
enum a3_DemoMode5_Beach_RenderMode
{
...
// render pipelines
enum a3_DemoMode5_Beach_RenderPipeline
{
...
// render passes
enum a3_DemoMode5_Beach_RenderPass
{
...
// render targets
enum a3_DemoMode5_Beach_RenderTarget
{
	// scene targets
...
enum a3_DemoMode5_Beach_ObjectMaxCount
{
...
struct a3_DemoMode5_Beach
{
	// render mode
	a3_DemoMode5_Beach_RenderMode renderMode;

	// render pipeline
	a3_DemoMode5_Beach_RenderPipeline renderPipeline;

	// render pass
	a3_DemoMode5_Beach_RenderPass renderPass;

	// render targets
	a3_DemoMode5_Beach_RenderTarget renderTarget[animate_renderPass_max], renderTargetCount[animate_renderPass_max];
...
#endif	// !__ANIMAL3D_DemoMode5_Beach_H