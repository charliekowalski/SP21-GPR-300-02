...
void a3demo_loadShaders(a3_DemoState *demoState)
{
	...
	union {
	...
	} shaderList = {
		{
			...
			// 00-common
			{ { { 0 },	"shdr-vs:pass-tex-trans",			a3shader_vertex  ,	1,{ A3_DEMO_VS"00-common/e/passTexcoord_transform_vs4x.glsl" } } },// ****DECODE - texture
			{ { { 0 },	"shdr-vs:pass-tb-trans",			a3shader_vertex  ,	1,{ A3_DEMO_VS"00-common/e/passTangentBasis_transform_vs4x.glsl" } } },// ****DECODE - lambert/phong
			...
			// 00-common
			{ { { 0 },	"shdr-fs:draw-tex",					a3shader_fragment,	1,{ A3_DEMO_FS"00-common/e/drawTexture_fs4x.glsl" } } },// ****DECODE - texture
			{ { { 0 },	"shdr-fs:draw-Lambert",				a3shader_fragment,	2,{ A3_DEMO_FS"00-common/e/drawLambert_fs4x.glsl",// ****DECODE - lambert
																					A3_DEMO_FS"00-common/e/utilCommon_fs4x.glsl",} } },// ****DECODE - lambert/phong
			{ { { 0 },	"shdr-fs:draw-Phong",				a3shader_fragment,	2,{ A3_DEMO_FS"00-common/e/drawPhong_fs4x.glsl",// ****DECODE - phong
																					A3_DEMO_FS"00-common/e/utilCommon_fs4x.glsl",} } },// ****DECODE - lambert/phong
		}
	};
