...
void a3ssfx_render(a3_DemoState const* demoState, a3_DemoMode2_SSFX const* demoMode, a3f64 const dt)
{
	...
	if (renderMode == ssfx_renderModePhongDL)
	{
		...
		a3shaderUniformSendFloatMat(a3unif_mat4, 0, currentDemoProgram->ubLight, 1, demoState->ubo_transform);	//Light transforms
		a3shaderUniformSendFloatMat(a3unif_mat4, 0, currentDemoProgram->uPB_inv, 1, projectionBiasMatInv.mm);			//ProjectionBiasInverse
	...
	case ssfx_renderModePhongDS:
		...
		//a3shaderUniformSendFloatMat(a3unif_mat4, 0, currentDemoProgram->ubLight, 1, demoState->ubo_light);		//INCORRECT		//Light buffer
