...
void a3animate_loadValidate(a3_DemoState* demoState, a3_DemoMode5_Beach* demoMode)
{
	void a3animate_input(a3_DemoState* demoState, a3_DemoMode5_Beach * demoMode, a3f64 const dt);
	void a3animate_update(a3_DemoState* demoState, a3_DemoMode5_Beach * demoMode, a3f64 const dt);
	void a3animate_render(a3_DemoState const* demoState, a3_DemoMode5_Beach const* demoMode, a3f64 const dt);
	void a3animate_input_keyCharPress(a3_DemoState const* demoState, a3_DemoMode5_Beach * demoMode, a3i32 const asciiKey, a3i32 const state);
	void a3animate_input_keyCharHold(a3_DemoState const* demoState, a3_DemoMode5_Beach * demoMode, a3i32 const asciiKey, a3i32 const state);
...
void a3animate_load(a3_DemoState const* demoState, a3_DemoMode5_Beach* demoMode)
{
