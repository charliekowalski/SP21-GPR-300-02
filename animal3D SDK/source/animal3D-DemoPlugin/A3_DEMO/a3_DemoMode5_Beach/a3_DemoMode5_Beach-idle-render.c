...
/*
	...
	a3_DemoMode5_Beach-idle-render.c
...
void a3animate_render_controls(a3_DemoState const* demoState, a3_DemoMode5_Beach const* demoMode,
	...
	a3f32 const textAlign, a3f32 const textDepth, a3f32 const textOffsetDelta, a3f32 textOffset)
{
	...
	// modes
	a3_DemoMode5_Beach_RenderMode const renderMode = demoMode->renderMode;
	a3_DemoMode5_Beach_RenderPass const renderPipeline = demoMode->renderPipeline;
	a3_DemoMode5_Beach_RenderPass const renderPass = demoMode->renderPass;
	a3_DemoMode5_Beach_RenderTarget const renderTarget = demoMode->renderTarget[renderPass],
...
void a3animate_render(a3_DemoState const* demoState, a3_DemoMode5_Beach const* demoMode, a3f64 const dt)
{
	...
	// target info
	a3_DemoMode5_Beach_RenderMode const renderMode = demoMode->renderMode;
	a3_DemoMode5_Beach_RenderPipeline const renderPipeline = demoMode->renderPipeline;
	a3_DemoMode5_Beach_RenderPass const renderPass = demoMode->renderPass;
	a3_DemoMode5_Beach_RenderTarget const renderTarget = demoMode->renderTarget[renderPass],
		renderTargetCount = demoMode->renderTargetCount[renderPass];
